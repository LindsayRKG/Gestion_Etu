...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $credit = $_POST['pension'];
   
    

    $sql = "UPDATE classes SET nom = :nom, pension = :pension WHERE id = :id";
    $stmt = $db->prepare($sql);

    $stmt->bindParam(':nom', $nom);
    $stmt->bindParam(':pension', $credit);
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item d-block d-lg-none">
          <a class="nav-link nav-icon search-bar-toggle " href="classes.php">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Classe / Modification</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-12">
              ...
              <form method="post" >
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Pension:</label>
                  <div class="col-sm-10">
                    <input name="pension" type="text" class="form-control" value="<?= htmlspecialchars($etudiant['pension']) ?>" required>
                  </div>
                </div>
