...
<head>
  ...
  <title>Versements de l'étudiant</title>
...
<body>
  ...
  <div class="logo-corner">
    ...
    <h1> Consultez vos versements </h1>
    <h2>Versements</h2>
    <table>
      <thead>
        <tr>
        ...
        if ($versements) {
          foreach ($versements as $versement) {
            echo "<tr>
                    ...
                    <td>" . $versement['matricule_versement'] . "</td>
                  </tr>";
          }
        } else {
          echo "<tr><td colspan='3'>Aucun versement trouvé</td></tr>";
        }
        ?>
      </tbody>
    </table>
