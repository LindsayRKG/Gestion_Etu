        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <button onclick="window.location.href='classesform.php';" type="button" class="btn btn-outline-primary">Nouvelle classe</button>
                ...
                <tbody>
                  <?php foreach ($result as $etudiants): ?>
                    <tr>
                      ...
                      <td><?= htmlspecialchars($etudiants['pension'] ?? 'Inconnu') ?></td>
                     
                      <td>
                          <a href="modifclasses.php?id=<?= urlencode($etudiants['id']) ?>" class="btn btn-warning"><i class="bi bi-feather"></i></a>
                          <a href="supprimerclasses.php?id=<?= urlencode($etudiants['id']) ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce classes ?')"><i class="bi bi-trash"></i></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
