    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">classes / Enregistrement</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Enregistrer une classe</h5>
              <form action="classesrecup.php" method="post" >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="pension" type="number" class="form-control" required>
                  </div>
                </div>
